...
function OneDay() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://www.fxempire.com/api/v1/en/stocks/chart/candles?Identifier=AAPL.XNAS&IdentifierType=Symbol&AdjustmentMethod=All&IncludeExtended=False&period=24&Precision=Hours&StartTime=8/28/2020%2016:0&EndTime=9/4/2020%2023:59&_fields=ChartBars.StartDate,ChartBars.High,ChartBars.Low,ChartBars.StartTime,ChartBars.Open,ChartBars.Close,ChartBars.Volume`
      )
    ...
    <div className="mainChart">
      <ResponsiveContainer width="95%" height={400}>
        <AreaChart data={state}>
          ...
          <XAxis dataKey="StartDate" axisLine="false" tickLine="false" />
          <YAxis
            datakey="Close"
            tickCount="6"
            domain={[
